...
- [ ] Implementar benchmark (formas de dar load em um arquivo pronto)
- [ ] Fazer com que os pontos sejam precisos na hora de dar hover (Saber para um valor exato de xy)


- Most commercial computer programs will include the shear deformation by having you input the shear area, As=ks*A
